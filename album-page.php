            ...
            <div class="row margin">
                ...
                <?php 
                    if (isset($_GET['album_id'])) {
                        $get_sel = "SELECT * FROM latest_album WHERE albumname = '$_GET[album_id]'";
                        $get_query = mysqli_query($db,$get_sel);
                            while ($albumid = mysqli_fetch_assoc($get_query)) {
                                echo "
                                <div class='row row-wrapper'>
                        <div class='col-md-12 album-head'><h4>$albumid[albumname]</h4></div>
                    </div>
                    
                    <div class='row row-wrapper'>
                        <div class='col-md-4'>
                            <div class='img-wrapper'><img class='album-img' src='images/$albumid[albumpic]'></div>
                        </div>
                        ...
                        <div class='col-md-8'>
                            <div class='border-wrapper margin-top'>
                                <ul class='ul-table'>
                                    <li class='li-table'>
                                        <div><span class='property col-sm-6'>Album </span><span class='value col-sm-6'>$albumid[albumname]</span></div>
                                    </li>
                                    <li class='li-table'>
                                        <div><span class='property col-sm-6'>Released </span><span class='value col-sm-6'>$albumid[albumreleasedate]</span></div>
                                    </li>
                                    <li class='li-table1'>
                                        <div><span class='property col-sm-6'>Cast </span><span class='value col-sm-6'>$albumid[albumcast]</span></div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class='ul-table'>
                                    <li class='li-table'>
                                        <div>
                                            <div class='album-song'>
                                                <span class='col-sm-4'>
                                                    <i style='margin-right:5px;' class='fa fa-music' aria-hidden='true'></i>01 $albumid[songname1]
                                                </span>
                                                <span class='col-sm-2'></span>
                                                    <audio data-mejsoptions class='mejs__player'>
                                                        <source src='music/$albumid[albumsong1]' type='audio/mpeg'>
                                                        Your browser does not support the audio element.
                                                    </audio>
                                            </div>
                                            <div class='song-details'><p></p></div>
                                            <div class='dl-link'><p><a  href='music/$albumid[albumsong1]' download>Download</a></p></div>
                                    ...
                                    <li class='li-table'>
                                        <div>
                                            <div class='album-song'>
                                                <span class='col-sm-4'>
                                                    <i style='margin-right:5px;' class='fa fa-music' aria-hidden='true'></i>02 $albumid[songname2]
                                                </span>
                                                <span class='col-sm-2'></span>
                                                    <audio data-mejsoptions class='mejs__player'>
                                                        <source src='music/$albumid[albumsong2]' type='audio/mpeg'>
                                                        Your browser does not support the audio element.
                                                    </audio>
                                            </div>
                                            <div class='song-details'><p></p></div>
                                            <div class='dl-link'><p><a  href='music/$albumid[albumsong2]' download>Download</a></p></div>
                                    ...
                                    <li class='li-table1'>
                                        <div>
                                            <div class='album-song'>
                                                <span class='col-sm-4'>
                                                    <i style='margin-right:5px;' class='fa fa-music' aria-hidden='true'></i>03 $albumid[songname3]
                                                </span>
                                                <span class='col-sm-2'></span>
                                                    <audio data-mejsoptions class='mejs__player'>
                                                        <source src='music/$albumid[albumsong3]' type='audio/mpeg'>
                                                        Your browser does not support the audio element.
                                                    </audio>
                                            </div>
                                            <div class='song-details'><p></p></div>
                                            <div class='dl-link'><p><a  href='music/$albumid[albumsong3]' download>Download</a></p></div>
                                     ...
                                     <li class='li-table1'>
                                        <div>
                                            <div class='album-song'>
                                                <span class='col-sm-4'>
                                                    <i style='margin-right:5px;' class='fa fa-music' aria-hidden='true'></i>04 $albumid[songname4]
                                                </span>
                                                <span class='col-sm-2'></span>
                                                    <audio data-mejsoptions class='mejs__player'>
                                                        <source src='music/$albumid[albumsong4]' type='audio/mpeg'>
                                                        Your browser does not support the audio element.
                                                    </audio>
                                            </div>
                                            <div class='song-details'><p></p></div>
                                            <div class='dl-link'><p><a  href='music/$albumid[albumsong4]' download>Download</a></p></div>
                                     ...
                                     <li class='li-table1'>
                                        <div>
                                            <div class='album-song'>
                                                <span class='col-sm-4'>
                                                    <i style='margin-right:5px;' class='fa fa-music' aria-hidden='true'></i>05 $albumid[songname5]
                                                </span>
                                                <span class='col-sm-2'></span>
                                                    <audio data-mejsoptions class='mejs__player'>
                                                        <source src='music/$albumid[albumsong5]' type='audio/mpeg'>
                                                        Your browser does not support the audio element.
                                                    </audio>
                                            </div>
                                            <div class='song-details'><p></p></div>
                                            <div class='dl-link'><p><a  href='music/$albumid[albumsong5]' download>Download</a></p></div>
                                     ...
                                     <li class='li-table1'>
                                        <div>
                                            <div class='album-song'>
                                                <span class='col-sm-4'>
                                                    <i style='margin-right:5px;' class='fa fa-music' aria-hidden='true'></i>06 $albumid[songname6]
                                                </span>
                                                <span class='col-sm-2'></span>
                                                    <audio data-mejsoptions class='mejs__player'>
                                                        <source src='music/$albumid[albumsong6]' type='audio/mpeg'>
                                                        Your browser does not support the audio element.
                                                    </audio>
                                            </div>
                                            <div class='song-details'><p></p></div>
                                            <div class='dl-link'><p><a  href='music/$albumid[albumsong6]' download>Download</a></p></div>
