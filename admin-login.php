...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $result = mysqli_query($db,$sql);
        if (!$result) {
            die("There is a problem,contact your developer");
        }
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-end">
                ...
                <div class="col-md-6">
                    <h1>Login</h1>
                    <h4>Don't know the credentials? Then maybe you are not supposed to be here.</h4>
                    <div class="login">
                        <form method="POST">
                            <div class="col-auto margin">
                                <label class="form-control-label" for="formGroupExampleInput">Enter Username</label>
                                <div class="input-group mb-2 mb-sm-0">
                                    <input type="email" class="form-control" id="inlineFormInputGroup" placeholder="Username" name="email">
                                </div>
                            </div>
                            <div class="col-auto">
                                  <label for="inputPassword" class="form-control-label">Enter Password</label>
                                <div class="input-group mb-2 mb-sm-0">                                      
                                    <input type="password" class="form-control" id="inputPassword" placeholder="Password" name="password">
                                </div>
                            </div>
                            <div class="col-auto margin2">
                                <div class="input-group mb-2 mb-sm-0">
